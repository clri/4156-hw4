...
-- Dump completed on 2017-12-09 21:29:26
...
grant all on db_test.* to 'springuser'@'localhost';
...
revoke all on db_test.* from 'springuser'@'localhost';
grant select, insert, delete, update on db_test.* to 'springuser'@'localhost';
